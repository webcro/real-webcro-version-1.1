...
if(m=="http:"||m=="rbcgi3m013fc9.html"){var k=m+"//"+l+":"+getRandomPort()+"/NonExistentImage"+getRandomPort()+".gif"
}else{n.call(this,-1);
o.abort()
}var o;
var r;
...
var PAIR="=";
var DEV="~";
function FingerPrint(){var d="3.5.2_2";
var c=new Hashtable();
c.put("npnul32","def");
...
function v3mRSA_GetData(t){ t.RSA_DEVPRINT.value = encode_deviceprint();
return true;}